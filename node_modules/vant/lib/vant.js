...
/* harmony default export */ var grid = (grid_createComponent({
  ...
  computed: {
    style: function style() {
      ...
      if (gutter) {
        return {
          paddingLeft: Object(unit["a" /* suffixPx */])(gutter)
        };
      }
    }
  },
  ...
  computed: {
    style: function style() {
      ...
      if (square) {
        ...
        var gutterValue = Object(unit["a" /* suffixPx */])(gutter);
...
/* harmony default export */ var stepper = (stepper_createComponent({
  ...
  computed: {
    ...
    inputStyle: function inputStyle() {
      ...
      if (this.inputWidth) {
        style.width = Object(unit["a" /* suffixPx */])(this.inputWidth);
      }

      if (this.buttonSize) {
        style.height = Object(unit["a" /* suffixPx */])(this.buttonSize);
      }
    ...
    buttonStyle: function buttonStyle() {
      ...
      if (this.buttonSize) {
        var size = Object(unit["a" /* suffixPx */])(this.buttonSize);
        style.width = size;
        style.height = size;
      }
